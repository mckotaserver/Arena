## クエスト登録
# 項の作成
data modify storage arena:assets utility.quests append value {id:"all_completion.50"}
...
data modify storage arena:assets utility.quests[-1].requirement set value {}
    ...
    data modify storage arena:assets utility.quests[-1].requirement.mob_type set value 5
    data modify storage arena:assets utility.quests[-1].requirement.count set value 15
    data modify storage arena:assets utility.quests[-1].requirement.difficulty set value 0
...
data modify storage arena:assets utility.quests[-1].difficulty set value "easy"

# 報酬
data modify storage arena:assets utility.quests[-1].reward set value {}
    data modify storage arena:assets utility.quests[-1].reward.point set value 2
    data modify storage arena:assets utility.quests[-1].reward.loot_table set value "arena_utility:quest_reward/tier_1"
    data modify storage arena:assets utility.quests[-1].reward.money set value {value:500,count:1}
