## クエスト登録
# 項の作成
data modify storage arena:assets utility.quests append value {id:"all_completion.30"}
...
data modify storage arena:assets utility.quests[-1].requirement set value {}
    ...
    data modify storage arena:assets utility.quests[-1].requirement.mob_type set value 3
