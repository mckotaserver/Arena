## クエスト登録
# 項の作成
data modify storage arena:assets utility.quests append value {id:"difficulty_completion.1"}
...
data modify storage arena:assets utility.quests[-1].reward set value {}
    ...
    data modify storage arena:assets utility.quests[-1].reward.money set value {value:500,count:5}
