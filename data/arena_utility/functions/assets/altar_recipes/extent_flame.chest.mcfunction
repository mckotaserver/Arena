## レシピ登録
# 項の作成
data modify storage arena:assets utility.altar_recipes append value {id:"extent_flame.chest"}
...
# 成果物
data modify storage arena:assets utility.altar_recipes[-1].product set value {"id":"minecraft:diamond_chestplate","Count":1b,tag:{display:{Name:'{"text":"エクステントフレイム","color":"yellow","italic":false}'},Enchantments:[{id:"minecraft:protection",lvl:5s},{id:"minecraft:fire_protection",lvl:4s}]}}
