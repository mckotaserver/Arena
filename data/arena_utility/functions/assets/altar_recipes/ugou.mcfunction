...
data modify storage arena:assets utility.altar_recipes[-1].ingredients set value []
    ...
    data modify storage arena:assets utility.altar_recipes[-1].ingredients append value {id:"minecraft:raw_copper",Count:64b,tag:{}}

    data modify storage arena:assets utility.altar_recipes[-1].ingredients append value {id:"minecraft:dragon_egg",Count:2b,tag:{}}

# 成果物
data modify storage arena:assets utility.altar_recipes[-1].product set value {"id":"minecraft:bow","Count":1b,tag:{display:{Name:'{"text":"《 烏号 》","color":"red","italic":false}'},Enchantments:[{id:"minecraft:power",lvl:7s},{id:"minecraft:infinity",lvl:1s},{id:"minecraft:mending",lvl:1s},{id:"minecraft:unbreaking",lvl:4s}],AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.10,Operation:1,UUID:[I;-1416549046,-508211889,-1569361097,-882803624],Slot:"mainhand"}],arena:{direct_enchanting:{available:"infinite_and_mending",item_type:"tool",tool_type:"bow"}}}}
