## レシピ登録
# 項の作成
data modify storage arena:assets utility.altar_recipes append value {id:"dark_netherite_boots"}

#> レシピデータ
# Recipe
data modify storage arena:assets utility.altar_recipes[-1].ingredients set value []
    data modify storage arena:assets utility.altar_recipes[-1].ingredients append value {id:"minecraft:netherite_boots",Count:1b,tag:{Damage:0},isCore:true}
...
# 成果物
data modify storage arena:assets utility.altar_recipes[-1].product set value {"id":"minecraft:netherite_boots","Count":1b,tag:{display:{Name:'{"text":"ダークネザライトブーツ","color":"light_purple","italic":false}'},Trim:{material:"dark_netherite",pattern:"dark_netherite"},HideFlags:128,AttributeModifiers:[{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:2,Operation:0,UUID:[I;-537972589,-575846429,-1888451607,496710399],Slot:"feet"},{AttributeName:"generic.armor",Name:"generic.armor",Amount:8,Operation:0,UUID:[I;1466641190,1898794879,-1875769186,512229959],Slot:"feet"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:4,Operation:0,UUID:[I;-1263507428,1569867733,-1509797238,-838003936],Slot:"feet"},{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Amount:0.12,Operation:0,UUID:[I;1190775837,389762170,-1647779057,-1291675790],Slot:"feet"}]}}
