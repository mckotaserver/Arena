...
execute store result score #Utility.Altar.RecipeElements-2 Arena.Temp run data get storage arena_utility:temp Altar.data.PlacedItem
...
execute if data storage arena_utility:temp Altar.Crafting.Recipes[0] run function arena_utility:altar/crafting/recipe_check
