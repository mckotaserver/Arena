...
# アイテムのidをみる
    # データの取得
    data modify storage arena_utility:temp Altar.Crafting.UpgradeRecipe.Type set from storage arena_utility:temp Altar.Crafting.Refering.ingredients[{isCore:true}].type
