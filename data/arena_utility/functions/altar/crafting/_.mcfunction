...
#> クラフト可能状態か判定
    ...
    # 強化レシピ → 独自判定
    execute if data storage arena_utility:temp {Altar:{Crafting:{Refering:{inherit_core_item:true}}}} run function arena_utility:altar/crafting/upgrade_recipe/checking
