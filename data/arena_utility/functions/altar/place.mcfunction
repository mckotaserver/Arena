...
#> 各種エンティティ
    ...
    # Item Display
    execute at @e[tag=arena.Utility.Altar.Core] run summon item_display ~ ~-1 ~ {item:{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:2000070}},Tags:["arena.Utility.Altar.item_display","arena.Utility.Altar.Element"],"transformation":{right_rotation:[0,0,0,1],left_rotation:[0,0,0,1],scale:[1.25f,1f,1.25f],translation:[0.0f,0.125f,0.0f]}}
