...
execute as @p[tag=Arena.Player] in minecraft:overworld run loot replace block 0 -64 0 container.0 loot arena:misc/player_head
...
# タイムスタンプ
execute store result storage arena:temp MergingRecord.PlayerData.TimeStamp int 1 run time query gametime
