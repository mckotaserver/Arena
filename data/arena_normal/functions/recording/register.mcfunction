...
# データベースに挿入
    ...
    data modify storage arena_normal:temp recording.insertion.name set from entity @e[tag=arena.normal_stage.stage_core,sort=nearest,limit=1] data.arena.stage_detail.name
