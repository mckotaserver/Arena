...
#> 各種構成エンティティを再Summon
# text_display: 【通常アリーナ】
summon text_display ~ ~ ~ {"transformation":{right_rotation:[0,0,0,1],left_rotation:[0,0,0,1],scale:[1.25f,1.25f,1.25f],translation:[0.0f,1.5f,0.0f]},"alignment":"center",Tags:["arena.normal-stage.Selector.Element-01","arena.normal-stage.Selector"],text:'{"text": "","extra": [{"text": "【","color": "dark_aqua","bold": true},{"text": "エンドレスアリーナ","color": "aqua","bold": true},{"text": "】","color": "dark_aqua","bold": true}]}'}
