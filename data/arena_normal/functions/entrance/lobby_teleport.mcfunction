...
$execute at @e[tag=Arena.Normal-Stage.Lobby_$(LobbyName)] positioned ^ ^-0.5 ^-10 unless entity @e[tag=Arena.Normal-Stage.Selector-Core,distance=..1] run summon marker ~ ~ ~ {Tags:["Arena.Normal-Stage.Selector-Core"]}
