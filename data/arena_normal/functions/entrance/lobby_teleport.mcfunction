...
# リセット処理
$execute at @e[tag=Arena.Normal-Stage.Lobby_$(LobbyName)] as @e[tag=Arena.Normal-Stage.Selector-Core,sort=nearest,limit=1] at @s run function arena_normal:entrance/stage_selector/reset
