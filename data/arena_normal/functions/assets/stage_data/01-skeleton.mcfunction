...
data modify storage arena:assets stage_data[-1].mob_data set value []
    ...
    data modify storage arena:assets stage_data[-1].mob_data append value {id:"minecraft:stray",weight:1,multiplier:0.60,condition:{wave:{min:3},difficulty:{min:1,max:2}},data:{ArmorItems:[{id:"minecraft:diamond_boots",Count:1b},{},{},{id:"minecraft:diamond_helmet",Count:1b}],ArmorDropChances:[0.005f,0.005f,0.005f,0.005f],HandItems:[{id:"minecraft:bow",Count:1b,tag:{Enchantments:[{id:"minecraft:punch",lvl:2s}]}},{}],Attributes:[{Name:"minecraft:generic.movement_speed",Modifiers:[{Amount:-0.1,Operation:2,UUID:[I;0,0,0,0]}]}]}}
