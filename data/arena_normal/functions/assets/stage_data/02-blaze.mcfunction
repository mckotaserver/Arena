...
data modify storage arena:assets stage_data[-1].mob_data set value []
    ...
    data modify storage arena:assets stage_data[-1].mob_data append value {id:"minecraft:wither_skeleton",weight:2,multiplier:1.50,condition:{wave:{min:3},difficulty:{min:2,max:2}},data:{DeathLootTable:"minecraft:empty",ArmorItems:[{id:"minecraft:iron_boots",Count:1b},{},{},{}],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f],HandDropChances:[-1E40f,-1E40f],HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{Enchantments:[{id:"minecraft:knockback",lvl:2s}]}},{}],Attributes:[{Name:"minecraft:generic.movement_speed",Modifiers:[{Amount:-0.1,Operation:0,UUID:[I;0,0,0,0]}]}]}}
