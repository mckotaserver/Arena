...
$execute store result storage arena:temp SpawningData.Detail-Modified.summon_count int 1 run data get storage arena:temp SpawningData.Detail-Original.summon_count[$(Wave)] $(Multiplier)
