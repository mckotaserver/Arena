...
execute as @e[tag=Arena.Normal-Stage.Stage-Core] if score @s Arena.Temp = #EndTick Arena.Temp at @s run function arena_normal:end/main with entit @s data.Arena
