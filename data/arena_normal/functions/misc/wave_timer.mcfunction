...
execute as @e[tag=Arena.Normal-Stage.Stage-Core] if score @s Arena.Temp = #CurrentTick Arena.Temp run data modify entity @s data.Arena.Timer.WaveWaiting set value false
