...
data modify storage arena:temp MarkerExistance set value true

execute positioned ~21 ~ ~ unless entity @e[tag=Arena.Normal-Stage.SpawnMarker,distance=..2] run data modify storage arena:temp MarkerExistance set value false
execute positioned ~-21 ~ ~ unless entity @e[tag=Arena.Normal-Stage.SpawnMarker,distance=..2] run data modify storage arena:temp MarkerExistance set value false
execute positioned ~ ~ ~21 unless entity @e[tag=Arena.Normal-Stage.SpawnMarker,distance=..2] run data modify storage arena:temp MarkerExistance set value false
execute positioned ~ ~ ~-21 unless entity @e[tag=Arena.Normal-Stage.SpawnMarker,distance=..2] run data modify storage arena:temp MarkerExistance set value false

execute if data storage arena:temp {MarkerExistance:false} run kill @e[tag=Arena.Normal-Stage.SpawnMarker,distance=..48]

execute if data storage arena:temp {MarkerExistance:false} run summon marker ~21 ~ ~ {Tags:["Arena.Normal-Stage.SpawnMarker"]}
execute if data storage arena:temp {MarkerExistance:false} run summon marker ~-21 ~ ~ {Tags:["Arena.Normal-Stage.SpawnMarker"]}
execute if data storage arena:temp {MarkerExistance:false} run summon marker ~ ~ ~21 {Tags:["Arena.Normal-Stage.SpawnMarker"]}
execute if data storage arena:temp {MarkerExistance:false} run summon marker ~ ~ ~-21 {Tags:["Arena.Normal-Stage.SpawnMarker"]}
