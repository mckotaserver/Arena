...
execute if entity @a[tag=Arena.AltarOpener] run tellraw @s [{"translate":"kota-server.arena.game.message.prefix"},{"translate":"kota-server.arena.boss.enchantment_altar.message.error.someone_already_opened_gui"}]
