...
execute if score @p[tag=Arena.Boss.Core-Player] ArenaBoss.Timer matches 5 as @a[tag=Arena.Boss.Player,distance=..4] run damage @s 20.0 magic by @e[tag=Arena.Boss.Main.Core,sort=nearest,limit=1]
execute if score @p[tag=Arena.Boss.Core-Player] ArenaBoss.Timer matches 10 as @a[tag=Arena.Boss.Player,distance=..4] run damage @s 20.0 magic by @e[tag=Arena.Boss.Main.Core,sort=nearest,limit=1]
