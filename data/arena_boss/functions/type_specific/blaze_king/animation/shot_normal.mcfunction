...
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 20 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:20f}
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 21 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:10f}
...
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 23 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:-10f}
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 24 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:-20f}

execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 25 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:25f}
...
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 28 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:-15f}
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 29 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:-25f}
...
execute if score @p[tag=arena.boss.Core-Player] Arenaboss.Timer matches 35 run function arena_boss:type_specific/blaze_king/animation/reset
