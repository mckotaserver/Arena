...
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 20..30 run function arena_boss:type_specific/blaze_king/misc/spin_fastest

execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 20 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:0f}
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 22 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:15f}
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 24 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:0f}
...
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 28 run function arena_boss:type_specific/blaze_king/animation/shot/summon {Rotation:0f}
