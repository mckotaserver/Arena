...
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 0 run playsound item.totem.use master @a ~ ~ ~ 5 1.25
...
execute if score @p[tag=arena.boss.core_player] arenaboss.Timer matches 0 run playsound item.firecharge.use master @a ~ ~ ~ 5 0.75
