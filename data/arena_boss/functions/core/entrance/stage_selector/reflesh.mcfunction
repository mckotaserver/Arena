...
$data modify entity @e[tag=Arena.Boss.Selector.Element-04,sort=nearest,limit=1] text set value '{"text": "","extra": [{"text": "［","color": "white","bold": true},{"nbt": "boss_data[$(BossStage)].display_data.name","storage":"arena:assets","color": "white", "bold": true, "interpret": true},{"text": "］","color": "white","bold": true}]}'
