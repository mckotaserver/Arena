...
execute store result entity @e[tag=Arena.Normal-Stage.Stage-Core,sort=nearest,limit=1] data.Arena.Wave int 1 run scoreboard players get #Debug.Wave Arena.Temp
